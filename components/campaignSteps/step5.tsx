...
type IStep5 = {
  ...
  setSocial: (slug: string, value: string) => any;
};
        ...
        >
          ...
          <Stack align={"center"} spacing={2}>
            ...
            <Text fontSize={"lg"} color={"gray.500"} textAlign="center">
              It will help people to showcase you work on social platform, and
              connect more with your cause.
            </Text>
          </Stack>
          ...
          >
            <Input
              ...
              value={socials[0].url}
              onChange={(e) => {
                setSocial(socials[0].slug, e.target.value);
              }}
              _focus={{
          ...
          >
            <Input
              ...
              value={socials[1].url}
              onChange={(e) => {
                setSocial(socials[1].slug, e.target.value);
              }}
              _focus={{
                bg: useColorModeValue("gray.200", "gray.800"),
                outline: "none",
          ...
          >
            <Input
              ...
              value={socials[2].url}
              onChange={(e) => {
                setSocial(socials[2].slug, e.target.value);
              }}
              border={0}
              _focus={{
                bg: useColorModeValue("gray.200", "gray.800"),
          ...
          >
            <Input
              ...
              value={socials[3].url}
              onChange={(e) => {
                setSocial(socials[3].slug, e.target.value);
              }}
              border={0}
              _focus={{
                bg: useColorModeValue("gray.200", "gray.800"),
